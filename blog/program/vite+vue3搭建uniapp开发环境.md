...
然后就是把一些`#ifndef VUE3`不是 vue3 的代码块，以及部分 js 文件改写成 ts 文件即可。这里把我修改后的模板上传到 github 上，有需要的可自行下载：[dasheng/vite-vue3-uniapp (github.com)](https://github.com/qidasheng369/vite-vue3-uniapp)
