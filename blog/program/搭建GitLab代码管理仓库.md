...
可以访问 [dasheng · GitLab](https://gitlab.dasheng.cn/dasheng) 来查看搭建效果。
...
1. 在 32 行左右，将 external_url 前面的#删掉，并在单引号中填写 gitlab 服务器的 https 地址，例如[https://gitlab.dasheng.cn](https://gitlab.dasheng.cn)

   ```
    external_url 'https://gitlab.dasheng.cn'
   ```
...
3. 在 2434 行左右（可通过搜索 letsencrypt 定位），修改下面几项
   ...
   letsencrypt['contact_emails'] = ['daSheng12@gmail.com'] #删除前面的#号,修改为自己的邮箱
...
```js
// 原仓库git
https://github.com/qidasheng369/blog
// 在https://后加上username@
https://dasheng@github.com/dasheng/blog
```
