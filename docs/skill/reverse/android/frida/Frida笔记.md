...
```bash
adb push C:\Users\dasheng\Desktop\frida-server-15.1.14-android-arm64 /data/local/tmp/fsarm64
...
let Utils = Java.use('com.dasheng.app.Utils')
```
...
```javascript
const Utils = Java.use('com.dasheng.app.Utils')
...
var Person = Java.use('com.dasheng.app.Person')
var person = Person.$new('dasheng', 20)
arrayList.add('dasheng')
...
```
adb push C:\Users\dasheng\Desktop\frida-inject-15.1.14-android-arm64 /data/local/tmp/fiarm64
